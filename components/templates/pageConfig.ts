...
export type SinglePageConfig = {
  ...
  text2Layout?: TextLayout;
  textSize: "sm" | "md" | "lg";
  textColor: string;
};

export const pageConfig: Record<number, SinglePageConfig> = {
  1:  { objectPosition: "65% 50%", textLayout: "top-right",   text2Layout: "bottom-left", textSize: "lg", textColor: "#1a1410" },
  4:  { objectPosition: "48% 52%", textLayout: "top-right",   textSize: "lg", textColor: "#1a1410" },
  5:  { objectPosition: "30% 50%", textLayout: "top-right",   textSize: "lg", textColor: "#1a1410" },
  6:  { objectPosition: "46% 50%", textLayout: "bottom-left", textSize: "lg", textColor: "#1a1410" },
  7:  { objectPosition: "54% 52%", textLayout: "bottom-right",textSize: "lg", textColor: "#1a1410" },
